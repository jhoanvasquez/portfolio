...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "My personal portfolio built with Next.js, showcasing my projects, skills, and experience as a full-stack developer.",
      tech: ["Next.js", "React.js", "TypeScript"],
      github: "https://github.com/jhoanvasquez/portfolio",
      demo: "#",
      featured: false,
    },
  ];
